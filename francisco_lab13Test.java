...
public class francisco_lab13Test 
{
	francisco_lab13 lab;
	...
	{
		assertEquals("testGetTotalCount Failed", lab.getTotalCount(), 1000);
	}
	
	@Test
	public void testGetOddCount() 
	{
		assertEquals("testGetOddCount Failed", lab.getOddCount(), 507);
	}
	
	@Test
	public void testGetEvenCount() 
	{
		assertEquals("testGetEvenCount Failed", lab.getEvenCount(), 493);
	}
	
	@Test
	public void testGetDistinctGreaterThanFiveCount() 
	{
		assertEquals("testGetDistinctGreaterThanFiveCount Failed", lab.getDistinctGreaterThanFiveCount(), 94);
	}
	
	@Test
	public void testGetResult1() 
	{
		assertArrayEquals("testGetResult1 Failed", expectedResult1, lab.getResult1());
	}
	
	@Test
	public void testGetResult2() 
	{
		assertArrayEquals("testGetResult2 Failed", expectedResult2, lab.getResult2());
	}
	
	@Test
	public void testGetResult3() 
	{
		assertArrayEquals("testGetResult3 Failed", expectedResult3, lab.getResult3());
	}
